...
using WebAPI.Implementation.Repositories;
using WebAPI.Implementation.Services;
...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = "server=localhost;user=root;database=jwt;port=3306;password=oladejimujib@gmail.com";
